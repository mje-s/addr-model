...
This model defines some Classes and Properties and also describes some defined in other models expected to be used.
...
| Expected Properties | <<isNameFor>>, <<hasPart>>, <<hasLifecycleStage>>
| Example
a| [source,turtle]
----
...
ex:oxford
    ...
    [
        rdf:value <https://linked.data.gov.au/dataset/gnaf/streetLocality/QLD140492> ;
        sdo:additionalType apt:road ;
    ] ,
    [
        rdf:value <https://linked.data.gov.au/dataset/gnaf/locality/loc38f189794e03> ;
        sdo:additionalType apt:locality ;
    ] ,
    [
        rdf:value <https://linked.data.gov.au/dataset/asgsed3/STE/3> ;
