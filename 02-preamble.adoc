...
[NOTE]
This model was adopted by ICSM's Address Working Group in June 2024 as the national model for address information in Australia. Various State/Territory agencies are working to implement the model in their respective jurisdictions.
